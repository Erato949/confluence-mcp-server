# Confluence MCP Server - Smithery.ai Compatible Dockerfile
...
# Install system dependencies (ensuring sh is available)
...
# Default command - HTTP server for Smithery.ai deployment
